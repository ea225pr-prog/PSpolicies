Configuration Audit_WinRM_KrbPlusNegotiate {
...
return (-not $Basic -and -not $Digest -and $Kerberos -and $Negotiate -and -not $Certificate -and -not $CredSSP)
'@
      SetScript = 'return $true'
    }
  }
}
Audit_WinRM_KrbPlusNegotiate
